...
const linesmrt = new Chart(smrtMRT, {
    ...
    data: {
        labels: ["2022", "2023", "2024", "2025", "May 2026"],
        datasets: [{
            label: "HBL",
            data: [3075000, 3675000, 4951000, 6050000, 6070000],
        ...
        {
            label: "CGL",
            data: [3020000, 3200000, 4450000, 6570000, 7000000],
        ...
        {
            label: "AEL",
            data: [3802000, 3721000, 4750000, 8060000, 8200000],
        ...
        {
            label: "NWL",
            data: [ 1840000, 1209000, 3210000, 7250000, 8200000],
        ...
        {
            label: "YSLRT",
            data: [2452000, 2482000, 4530000, 7050000, 7700000],
