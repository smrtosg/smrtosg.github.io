...
function updateHrefForDarkMode() {
    /* Banners */
    const aelysPage = document.getElementById('cv-aelys');

    const isDarkMode = document.body.classList.contains('dark-mode');

    if (isDarkMode) {
        /* Banners */
        aelysPage.style.backgroundImage = "url(../img/blog/rfheader.png)";


    } else {
        /* Banners */
        aelysPage.style.backgroundImage = "url(../img/blog/refheader.png)";
    }
